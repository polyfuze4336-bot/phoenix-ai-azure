...
| INT-APP-FOUNDRY | Next.js AI provider (`lib/ai`) | Microsoft Foundry / Azure OpenAI (`aif-yfjw6y`) | HTTPS (OpenAI-compatible) | Chat + multimodal wound analysis | Managed identity (Bearer, `cognitiveservices.azure.com`) | Prompts, image content, model completions | ACTIVE |
