...
- Invalidated the prior PWA cache; the replacement worker clears stale caches and reloads controlled
  windows on activation so installed clients cannot keep serving the retired page or navigation.
