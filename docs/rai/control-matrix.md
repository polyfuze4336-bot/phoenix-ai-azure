...
| RAI-SAFE-006 | Indication- and weight-gated Parkland | Reliability & Safety | Analysis | Active |
...
| RAI-TRANS-003 | AI labelling + analysis metadata | Transparency | Output | Active |
| RAI-TRANS-004 | Prompt/pipeline/schema versioning | Accountability | Output | Active |
| RAI-ACCT-001 | Human-in-the-loop review | Accountability | Oversight | Active |
...
| RAI-PRIV-008 | Server-authorized retained analysis access | Privacy & Security | Operations | Active |
...
| RAI-INCL-001 | Bilingual AI experience | Inclusiveness | Operations | Active |
