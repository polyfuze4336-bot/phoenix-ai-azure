...
const REGIONS = ['Head/Neck', 'Trunk', 'Upper Limb', 'Lower Limb', 'Perineum'] as const;
const AGE_GROUPS = ['0-5', '6-12', '13-18', '19-40', '41-60', '60+'] as const;
const OUTCOMES = ['HEALED', 'ONGOING', 'REFERRED', 'COMPLICATED'] as const;
const BURN_DEGREES = ['1ST', '2ND_SUPERFICIAL', '2ND_DEEP', '3RD', '4TH'] as const;
