...
const legacyTranslations: Record<string, LegacyTranslation> = {
  ...
  'analysis.subtitle': { en: 'Upload or capture a wound/burn image for AI-powered clinical assessment', bm: 'Muat naik atau tangkap imej luka/kelecuran untuk penilaian klinikal berkuasa AI' },
  ...
  'analysis.weight_help': { en: 'Weight enables an accurate Parkland calculation. No weight is assumed if left blank.', bm: 'Berat membolehkan pengiraan Parkland yang tepat. Tiada berat diandaikan jika dibiarkan kosong.' },
