 ...
 * are surfaced (read-only, non-sensitive) in the v2 "Analysis Information" panel and
 * the AI Assurance page.
 *
...
export const WOUND_ANALYSIS_CRITIC_PROMPT_VERSION = '2.1.0';

/** Single-pass fallback HCP prompt (used only when `AI_ANALYSIS_PIPELINE=single`). */
export const HCP_WOUND_ANALYSIS_PROMPT_VERSION = '1.0.0';

/** HCP clinical chat system prompt. */
export const HCP_CHAT_PROMPT_VERSION = '1.0.0';
