...
import { HCP_NAV, COMMUNITY_NAV, type NavItem } from '@/lib/nav';
import { isFeatureEnabled } from '@/lib/feature-flags';
import { APP_VERSION } from '@/lib/version';

interface PhoenixShellProps {
...
export function PhoenixShell({ variant = 'hcp', title, subtitle, children }: PhoenixShellProps) {
  ...
  const nav = visibleNav(variant === 'community' ? COMMUNITY_NAV : HCP_NAV);
  const homeHref = variant === 'community' ? '/community' : '/hcp';
